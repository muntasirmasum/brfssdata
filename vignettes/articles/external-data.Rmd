...
No unmatched respondents, which is the check to run after every
...
One type mismatch is common. `_STATE` is numeric in BRFSS,
...
status, all downloadable. For policy exposures, the
