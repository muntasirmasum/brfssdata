...
The data files live on GitHub releases, so any network that blocks or
...
and
[`brfss_crosswalk()`](https://muntasirmasum.github.io/brfssdata/reference/brfss_crosswalk.md)
fall back to catalog snapshots bundled with the package, so codebook
work runs before anything is downloaded.
...
#>   0.1.0.9000, <https://muntasirmasum.github.io/brfssdata/>.
#> 
